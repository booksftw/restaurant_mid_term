...
exports.seed = function(knex, Promise) {
  ...
  return Promise.all([
    ...
    knex('items').insert({name: 'Eggs', description: 'tasty in your mouth. CERTIFIED FREE RANGE EGGS, bacon, sausage, crispy potatoes, tomato.', image_url:"https://www.cbc.ca/inthekitchen/assets_c/2013/10/Steak'nEggs26-thumb-596x350-329015.jpg",price:12}),
