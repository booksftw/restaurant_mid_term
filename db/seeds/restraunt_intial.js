exports.seed = function(knex, Promise) {
  ...
  //       knex('restaurants').insert({name: 'Gio Cafe', logo_url:'https://cdn.websites.hibu.com/3446c3f773fc4983b12995f3adab4a82/dms3rep/multi/mobile/Cafe-Gio-logo.png', address:'201 Demacia st', phone_number:'123-456-7890' }),
  //       knex('menus').insert({name: 'Breakfast', description: 'breakfast menu', restrauntid: 1}),
